...
do
	...
	#echo "Run Number:$i" >> $4
	/gremlin-groovy-3/bin/gremlin.sh -e /scripts/tinker/TinkerLoad.groovy $2 $3 >> $4
	rm -r /tmp/*
done

# Example Run
# ./TinkerLoad.sh 5 ./HelloWorld.gdb ../../gremlin-groovy/data/graph-example-2.xml logs.txt
